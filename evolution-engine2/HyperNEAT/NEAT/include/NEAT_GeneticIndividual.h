...
namespace NEAT {
    ...
    public:
        ...
        inline double getOrigFitness() const {
            return origFitness;
        }

        inline double getNumFilled() const {
            return numFilled;
        }

        inline bool getMutatedAtBirth() const {
            return mutatedAtBirth;
        }

        inline int getNodesAdded() const {
            return nodesAdded;
        }

        inline int getLinksAdded() const {
            return linksAdded;
        }

        inline int getLinkWeightsMutated() const {
            return linkWeightsMutated;
        }

        inline int getLinkWeightsNotMutated() const {
            return linkWeightsNotMutated;
        }

        inline int getLinksDemolished() const {
            return linksDemolished;
        }

        inline double getParent1Fitness() const {
            return parent1Fitness;
        }

        inline double getParent2Fitness() const {
            return parent2Fitness;
        }

        inline string getParent1md5() const {
            return parent1md5;
        }

        inline string getParent2md5() const {
            return parent2md5;
        }

        inline string getThismd5() const {
            return thismd5;
        }
        ...
        inline int getParent1Order() const {
            return parent1Order;
        }

        inline int getParent2Order() const {
            return parent2Order;
        }

        inline double getBestFitnessInLineage() const {
            return bestFitnessInLineage;
        }
        ...
        inline void setParent1md5(string value) {
            parent1md5 = value;
        }

        inline void setParent2md5(string value) {
            parent2md5 = value;
        }

        inline void setThismd5(string value) {
            thismd5 = value;
        }

        inline void setOrder(double value) {
            order = value;
        }

        inline void setParent1Order(double value) {
            parent1Order = value;
        }

        inline void setParent2Order(double value) {
            parent2Order = value;
        }
